...
if (isset($_POST['insert'])) {
    ...
    if (mysqli_num_rows($result) == 0) {
        $sql = "INSERT INTO user (phone, pin, balance, points, roles) VALUES ('$phone', '$pin', '$balance', '$points', 'admin')";
        mysqli_query($db, $sql);
    } else {
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h2 style="margin-top: 20px; font-family: 'Noto Sans Thai', sans-serif; font-weight: 500; color: #4361EE ;">จัดการข้อมูลพนักงาน</h2>
                        <ol class="breadcrumb">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <button class="button" onclick="showPopup()">เพิ่มข้อมูลพนักงาน</button>
                                <hr>
                                ...
                                <div class="popup" id="popup">
                                    <div class="popup-content">
                                        ...
                                        <form action="" method="post">
                                            ...
                                            <input type="text" id="phone" name="phone" placeholder="Enter phone Username" required maxlength="10" autocomplete="new-password">

                                            <label for="pin">Password:</label>
                                            <input type="text" id="pin" name="pin" placeholder="Enter Password" required autocomplete="off" maxlength="6">
                                            <hr>
                                ...
                                <div class="table-responsive">
                                    <table id="mytable" class="table">
                                        <!-- HEADER -->
                                        <thead class="top-table" align="center">
                                            <th>ลำดับ</th>
                                            <th>เบอร์โทรศัพท์</th>
                                            <th>PIN</th>
                                            <th>แก้ไข</th>
                                        ...
                                        <tbody align="center">
                                            ...
                                            <?php
                                            $query = mysqli_query($db, "SELECT * FROM user WHERE roles='admin'");
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $result['pin'] ?></td>
                                                    <td>
                                                        <button name="edit" class="btn btn-success" onclick="showEditPopup(<?= $result['u_id'] ?>, '<?= $result['phone'] ?>', '<?= $result['pin'] ?>')">แก้ไข</button>
