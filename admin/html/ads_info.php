                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.php">
                        <!-- Logo icon --><b>
                            ...
                            <!-- Light Logo icon -->
                            <img src="pic/logo.png" alt="homepage" class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                    </a>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h2 style="margin-top: 20px; font-family: 'Noto Sans Thai', sans-serif; font-weight: 500; color: #4361EE ;">จัดการข้อมูลโฆษณา</h2>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">หน้าแรก</a></li>
                            <li class="breadcrumb-item active">จัดการข้อมูลโฆษณา</li>
                        </ol>
                    </div>
                </div>
                <!-- ============================================================== -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <button class="button" onclick="showPopup()">เพิ่มข้อมูลโฆษณา</button>
