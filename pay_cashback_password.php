...
<script>
        ...
        btn.forEach(val => {
          val.addEventListener("click", () => {
            ...
            var maskLength = inp.value.length 
...
<script>
  function changeLanguage(lang) {
    ...
    if (lang === 'th') {
      ...
      content_title_pay3.innerText = 'กรอกรหัสผ่าน เพื่อใช้เครดิตเงินเกิน';
      ...
      content_title_pay3.innerText = 'Enter your password to use your accumulated excess credit';
