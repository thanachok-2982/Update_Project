...
<body>
  <header>
    <div class="header-container">
      <a id="heading" class="logo-header-text" href="/index.php">
        <?= $vm_name['vm_name'] ?>
      </a>
        ...
        <div class="container-product-left-column">
          <div class="product-all">
            <div class="product-item-all">
              ...
              <p class="product-font1">
                <?= $result['name']; ?>
              </p>
              <p class="product-font2">
                <?= $result['p_price']; ?>฿
              </p>
            </div>
          </div>
  ...
  if (isset($_POST['btn-ok'])) {
    ...
    if ($phone < 9) {
      ...
      ?>
        <script>
          window.location.href = "pay_cashback_password.php?bu=<?= $bu ?>&id=<?= $id ?>&method=credit&price=<?= $result['p_price'] ?>&u_id=<?= $ruser['u_id'] ?>";
        </script>
        <?php
    } else if ($phone != $ruser['phone']) {
      ?>
...
<script>
  function changeLanguage(lang) {
    ...
    if (lang === 'th') {
      ...
      content_title_pay.innerText = 'เครดิตเงินเกิน';
      content_title_pay1.innerText = 'เครดิตเงินเกิน';
      content_title_pay2.innerText = 'เครดิตเงินเกิน';
      content_title_pay3.innerText = 'กรอกเบอร์มือถือ เพื่อใช้เครดิตเงินเกิน';
      ...
      content_title_pay.innerText = 'Excess Credit';
      content_title_pay1.innerText = 'Credit';
      content_title_pay2.innerText = 'Excess Credit';
      content_title_pay3.innerText = 'Enter mobile number to use accumulated excess credit';
