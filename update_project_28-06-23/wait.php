...
<head>
  ...
  <audio autoplay>
    <source src="/sound/sound-wait.mp3" type="audio/mp3">
  </audio>
</head>
...
<body>
  ...
  <div class="container-all">
    ...
    <div class="container-product-text">
      <div class="container-text">
        <p id="content_title_pay" class="text-product-all">กรุณารอรับสินค้าสักครู่</p>
      </div>
  ...
  <script>
    setTimeout(function() {
      window.location.href = "success.php?bu=<?= $bu ?>&id=<?= $id ?>&method=<?= $method ?>&price=<?= $price ?>&u_id=<?= $u_id ?>";
    }, 2000);
  </script>
...
<script>
  function changeLanguage(lang) {
    ...
    if (lang === 'th') {
      ...
      content_title_pay.innerText = 'กรุณารอรับสินค้าสักครู่';
      ...
      content_title_pay.innerText = 'Please wait for a moment to receive the product';
