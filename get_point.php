  ...
  <div class="container-all">
    ...
    <div class="container-product-center">
        ...
        <form method="post">
          <div class="numPan">
            ...
            <div class="numpad">
              ...
              <?php } else if ($newu_id != '') { ?>
                <p id="content_title_pay2" class="product-font1">ตั้งรหัส เพื่อสะสมคะแนน</p>
              <?php } ?>
      ...
      <div class="button-skip-bg">
        <a id="content_title_pay3" class="button-skip"></a>
      </div>
  ...
  <script>
    function changeLanguage(lang) {
      ...
      if (lang === 'th') {
        ...
        content_title_pay2.innerText = 'กรุณาตั้งรหัส เพื่อสะสมคะแนน';
