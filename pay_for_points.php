                ...
                <div class="text-name-number2">
                    <div class="text-name-number-all">
                        <div class="text-name-left">
                            ...
                            <p class="text-number1">คะเเนนที่ต้องใช้</p>
                        </div>
            ...
            <div class="button-all">
                <div class="button-left-right" >
                    ...
                    <div class="button-left">
                        <a class="button-all-left" href="/home.php?bu=<?=$bu?>">ยกเลิก</a>
                    </div>

                    <div class="button-right">
                        <a class="button-all-right" href="/wait.php?bu=<?= $bu ?>&id=<?= $id ?>&method=<?= $method ?>&price=<?= $totaluse ?>&u_id=<?= $u_id ?>">ยืนยัน</a>
                    </div>
