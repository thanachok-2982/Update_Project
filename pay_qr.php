  ...
  <script>
    function changeLanguage(lang) {
      ...
      if (lang === 'th') {
        ...
        content_title_pay.innerText = 'พร้อมเพย์';
        content_title_pay1.innerText = 'พร้อมเพย์';
        content_title_pay2.innerText = 'กรุณาสแกนคิวอาร์โค้ด';
        ...
        content_title_pay.innerText = 'Prompt Pay';
        content_title_pay1.innerText = 'Prompt Pay';
        content_title_pay2.innerText = 'Please scan the QR code';
