        ...
        <div class="button-left-right">
          ...
          if ($uinfo['balance'] >= $price) { ?>
            <div class="button-left">
              <a id="content_title_pay4" class="button-all-left" href="/home.php?bu=<?= $bu ?>">ยกเลิก</a>
            </div>

            <div class="button-right">
              <a id="content_title_pay5" class="button-all-right" href="/wait.php?bu=<?= $bu ?>&id=<?= $id ?>&method=<?= $method ?>&price=<?= $price ?>&u_id=<?= $u_id ?>">ยืนยัน</a>
            </div>
