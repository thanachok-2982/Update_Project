    ...
    <div class="container-all">
        <div class="container-all-back-closed">
            ...
            <div class="container-all-closed">
                <a class="fa-solid fa-circle-xmark" href="/home.php"
        ...
        <div class="container-product-text">
            <div class="container-text">
                <p class="text-product-all">ระบบได้เก็บเครดิตเงินเกินของคุณเเล้ว</p>
            </div>

            <div class="container-text-icon">
                <div class="container-icon-bg-blue">
                    <div class="icon-bg">
                        <img src="/pic//low-price.png" class="icon-loading" >
                    </div>
                </div>
            </div>
